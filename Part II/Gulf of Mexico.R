###################################################################
####################### Gulf of Mexico Data ####################### 
############# 315 storm peak significant wave heights #############
########################### ONE LOCATION ##########################
################# September 1900 - September 2005 ################# 
...
# Figure 3.9
#####
hist(x, probability=T, breaks = 30,main="", xlab= 'significant wave height (m)',
     ylim = c(0,0.3),mgp=c(1.8, .5, 0), col='gray', density=30, angle=30,border='black')  #same as reference paper
box(lty="solid",col='black')
axis(side=3, at=quantile(gom,probs = c(.25,.50,.65,.80,.90,.95,.975,.99)), 
...
# candidates
u_star=seq(0.204,7.804,by=0.1)   #length(u_star)=70 
...
plot(u,me_u,col='blue',xlim=c(0,8),ylim=c(1.8,3.4), cex=1.1,
     xaxt='n',yaxt='n', xlab='x / u*', ylab = 'Mean Excess')
axis(side=2, at=seq(1.8,3.4,by=0.2), labels=seq(1.8,3.4,by=0.2),tick=T)
axis(side=1, at=seq(0.204,7.804,by=0.1), labels=NA,tick=T, col='red')
axis(side=1, at=seq(0,8,by=1), labels=seq(0,8,by=1),tick=T)
title('Mean Excess Plots for Gulf of Mexico Data')

points(u_star,me_u_star,col='red',pch=4, cex=1, lwd=1)

y0_star<-wls_fit_star[[32]]$coefficients[1]
m_star<-wls_fit_star[[32]]$coefficients[2]
segments(u_star[32], u_star[32]*m_star+y0_star, x1 = u_star[77], y1 = u_star[77]*m_star+y0_star,
        lwd=3, col='red')

# Parameter estimates - 1st local min WMSE - BY PLOT LINE ADJUSTMENT
u_opt_WLS2<-u_star[32]
Nu_WLS2<-length(x[x>u_opt_WLS2])

fit_WLS_xi2<-m_star/(1+m_star)   #xi = A/(1+A) = 0.15595
fit_WLS_sigma2<-y0_star*(1-fit_WLS_xi2)+fit_WLS_xi2*u_opt_WLS2  #a_u*=B(1-xi)+xi*u =1.5495

# 100, 1000, 1000 year return levels (3 observations per year)
Q_100_WLS2<- u_opt_WLS2 + fit_WLS_sigma2/fit_WLS_xi2 * (((n/Nu_WLS2)*(1/300))^(-fit_WLS_xi2)-1)
Q_1000_WLS2<- u_opt_WLS2 + fit_WLS_sigma2/fit_WLS_xi2 * (((n/Nu_WLS2)*(1/3000))^(-fit_WLS_xi2)-1)
Q_10000_WLS2<- u_opt_WLS2 + fit_WLS_sigma2/fit_WLS_xi2 * (((n/Nu_WLS2)*(1/30000))^(-fit_WLS_xi2)-1)
...
# 100, 1000, 1000 year return levels (3 observations per year)
Q_100_WLS<- u_opt_WLS + fit_WLS_sigma/fit_WLS_xi * (((n/Nu_WLS)*(1/300))^(-fit_WLS_xi)-1)
Q_1000_WLS<- u_opt_WLS + fit_WLS_sigma/fit_WLS_xi * (((n/Nu_WLS)*(1/3000))^(-fit_WLS_xi)-1)
Q_10000_WLS<- u_opt_WLS + fit_WLS_sigma/fit_WLS_xi * (((n/Nu_WLS)*(1/30000))^(-fit_WLS_xi)-1)
...
text(0.2,0.9962,round(max(qqplot_cor),3), col='red', cex=0.8)
text(4.4,0.96,expression(' 4.136 \n (k=226)'), col='red', cex=0.8)
...
plot(quantis_qqplot,sort(x)[(k_qqplot+1):n]-sort(x)[k_qqplot], main='GP QQplot for maximum corelation Gulf of Mexico - u = 4.136', 
...
text(6.5,11.5,round(max(qqplot_cor),3), col='red', cex=0.8)
text(7,0,bquote(hat(xi) == 0.1953271), col='red', cex=0.8)
...
# 100, 1000, 1000 year return levels (3 observations per year)
Q_100_QQ<- u_opt_QQ + fit_QQ_sigma/fit_QQ_xi * (((n/Nu_QQ)*(1/300))^(-fit_QQ_xi)-1)
Q_1000_QQ<- u_opt_QQ + fit_QQ_sigma/fit_QQ_xi * (((n/Nu_QQ)*(1/3000))^(-fit_QQ_xi)-1)
Q_10000_QQ<- u_opt_QQ + fit_QQ_sigma/fit_QQ_xi * (((n/Nu_QQ)*(1/30000))^(-fit_QQ_xi)-1)

#####

#---------------------------------------------------- Surprise Plots
# Lee et al. (2015) - base code made available by Dr. Kate J. E. Lee
# Table 3.4 + Figure 3.10
#####
...
#u<-c(u[which(u[1:304]-u[2:305]<0)],u[305])  #295 thresholds
...
# A
Q_100_N_10<- u_opt_N_10 + fit_N_10_sigma/fit_N_10_xi * (((n/Nu_N_10)*(1/300))^(-fit_N_10_xi)-1)
Q_1000_N_10<- u_opt_N_10 + fit_N_10_sigma/fit_N_10_xi * (((n/Nu_N_10)*(1/3000))^(-fit_N_10_xi)-1)
Q_10000_N_10<- u_opt_N_10 + fit_N_10_sigma/fit_N_10_xi * (((n/Nu_N_10)*(1/30000))^(-fit_N_10_xi)-1)
# B
Q_100_N_10_2<- u_opt_N_10_2 + fit_N_10_2_sigma/fit_N_10_2_xi * (((n/Nu_N_10_2)*(1/300))^(-fit_N_10_2_xi)-1)
Q_1000_N_10_2<- u_opt_N_10_2 + fit_N_10_2_sigma/fit_N_10_2_xi * (((n/Nu_N_10_2)*(1/3000))^(-fit_N_10_2_xi)-1)
Q_10000_N_10_2<- u_opt_N_10_2 + fit_N_10_2_sigma/fit_N_10_2_xi * (((n/Nu_N_10_2)*(1/30000))^(-fit_N_10_2_xi)-1)
...
# # 100, 1000, 1000 year return levels (20.26 observations per year)
# # A
# Q_100_N_20<- u_opt_N_20 + fit_N_20_sigma/fit_N_20_xi * (((n/Nu_N_20)*(1/300))^(-fit_N_20_xi)-1)
# Q_1000_N_20<- u_opt_N_20 + fit_N_20_sigma/fit_N_20_xi * (((n/Nu_N_20)*(1/3000))^(-fit_N_20_xi)-1)
# Q_10000_N_20<- u_opt_N_20 + fit_N_20_sigma/fit_N_20_xi * (((n/Nu_N_20)*(1/30000))^(-fit_N_20_xi)-1)
# # B
# Q_100_N_20_2<- u_opt_N_20_2 + fit_N_20_2_sigma/fit_N_20_2_xi * (((n/Nu_N_20_2)*(1/300))^(-fit_N_20_2_xi)-1)
# Q_1000_N_20_2<- u_opt_N_20_2 + fit_N_20_2_sigma/fit_N_20_2_xi * (((n/Nu_N_20_2)*(1/3000))^(-fit_N_20_2_xi)-1)
# Q_10000_N_20_2<- u_opt_N_20_2 + fit_N_20_2_sigma/fit_N_20_2_xi * (((n/Nu_N_20_2)*(1/30000))^(-fit_N_20_2_xi)-1)

## Parameter estimates - 295 candidates
# # A
# u_opt_N_295_2<-u_opt_N_alt
# Nu_N_295_2<-length(x[x>u_opt_N_295_2])
# fit_N_295_2<- evir::gpd(x,u_opt_N_295_2)
# fit_N_295_2_xi<-fit_N_295_2$par.ests[[1]]
# fit_N_295_2_sigma<-fit_N_295_2$par.ests[[2]]
# # B
# u_opt_N_295<-u_opt_N
# Nu_N_295<-length(x[x>u_opt_N_295])
# fit_N_295<- evir::gpd(x,u_opt_N_295)
# fit_N_295_xi<-fit_N_295$par.ests[[1]]
# fit_N_295_sigma<-fit_N_295$par.ests[[2]]
# 
# #100, 1000, 1000 year return levels (3 observations per year)
# # A
# Q_100_N_295_2<- u_opt_N_295_2 + fit_N_295_2_sigma/fit_N_295_2_xi * (((n/Nu_N_295_2)*(1/300))^(-fit_N_295_2_xi)-1)
# Q_1000_N_295_2<- u_opt_N_295_2 + fit_N_295_2_sigma/fit_N_295_2_xi * (((n/Nu_N_295_2)*(1/3000))^(-fit_N_295_2_xi)-1)
# Q_10000_N_295_2<- u_opt_N_295_2 + fit_N_295_2_sigma/fit_N_295_2_xi * (((n/Nu_N_295_2)*(1/30000))^(-fit_N_295_2_xi)-1)
# # B
# Q_100_N_295<- u_opt_N_295 + fit_N_295_sigma/fit_N_295_xi * (((n/Nu_N_295)*(1/300))^(-fit_N_295_xi)-1)
# Q_1000_N_295<- u_opt_N_295 + fit_N_295_sigma/fit_N_295_xi * (((n/Nu_N_295)*(1/3000))^(-fit_N_295_xi)-1)
# Q_10000_N_295<- u_opt_N_295 + fit_N_295_sigma/fit_N_295_xi * (((n/Nu_N_295)*(1/30000))^(-fit_N_295_xi)-1)
...
# 100, 1000, 1000 year return levels (20.26 observations per year)
Q_100_B_10<- u_opt_B_10 + fit_B_10_sigma/fit_B_10_xi * (((n/Nu_B_10)*(1/300))^(-fit_B_10_xi)-1)
Q_1000_B_10<- u_opt_B_10 + fit_B_10_sigma/fit_B_10_xi * (((n/Nu_B_10)*(1/3000))^(-fit_B_10_xi)-1)
Q_10000_B_10<- u_opt_B_10 + fit_B_10_sigma/fit_B_10_xi * (((n/Nu_B_10)*(1/30000))^(-fit_B_10_xi)-1)
...
# 100, 1000, 1000 year return levels (20.26 observations per year)
Q_100_B_20<- u_opt_B_20 + fit_B_20_sigma/fit_B_20_xi * (((n/Nu_B_20)*(1/300))^(-fit_B_20_xi)-1)
Q_1000_B_20<- u_opt_B_20 + fit_B_20_sigma/fit_B_20_xi * (((n/Nu_B_20)*(1/3000))^(-fit_B_20_xi)-1)
Q_10000_B_20<- u_opt_B_20 + fit_B_20_sigma/fit_B_20_xi * (((n/Nu_B_20)*(1/30000))^(-fit_B_20_xi)-1)

# ## Parameter estimates - 305 candidates
# u_opt_B_305<-u_opt_B
# Nu_B_305<-length(x[x>u_opt_B_305])
# fit_B_305<- evir::gpd(x,u_opt_B_305)
# fit_B_305_xi<-fit_B_305$par.ests[[1]]
# fit_B_305_sigma<-fit_B_305$par.ests[[2]]
# 
# #100, 1000, 1000 year return levels (3 observations per year)
# Q_100_B_305<- u_opt_B_305 + fit_B_305_sigma/fit_B_305_xi * (((n/Nu_B_305)*(1/300))^(-fit_B_305_xi)-1)
# Q_1000_B_305<- u_opt_B_305 + fit_B_305_sigma/fit_B_305_xi * (((n/Nu_B_305)*(1/3000))^(-fit_B_305_xi)-1)
# Q_10000_B_305<- u_opt_B_305 + fit_B_305_sigma/fit_B_305_xi * (((n/Nu_B_305)*(1/30000))^(-fit_B_305_xi)-1)
...
text(0.8,1,"Selected Threshold = 3.9754")
text(0.8,0.96,"(k~221)")

# title("L-moment Ratio Diagram - 20 Candidate Thresholds")
# text(0.8,1,"Selected Threshold = 4.181544")
# text(0.8,0.96,"(k~231)")

# title("L-moment Ratio Diagram - 305 Candidate Thresholds")
# text(0.8,1,"Selected Threshold = 4.17")
# text(0.8,0.96,"(k=229)")
...
# 100, 1000, 1000 year return levels (3 observations per year)
Q_100_L_10<- u_opt_L_10 + fit_L_10_sigma/fit_L_10_xi * (((n/Nu_L_10)*(1/300))^(-fit_L_10_xi)-1)
Q_1000_L_10<- u_opt_L_10 + fit_L_10_sigma/fit_L_10_xi * (((n/Nu_L_10)*(1/3000))^(-fit_L_10_xi)-1)
Q_10000_L_10<- u_opt_L_10 + fit_L_10_sigma/fit_L_10_xi * (((n/Nu_L_10)*(1/30000))^(-fit_L_10_xi)-1)
...
# 
# # 100, 1000, 1000 year return levels (3 observations per year)
# Q_100_L_20<- u_opt_L_20 + fit_L_20_sigma/fit_L_20_xi * (((n/Nu_L_20)*(1/300))^(-fit_L_20_xi)-1)
# Q_1000_L_20<- u_opt_L_20 + fit_L_20_sigma/fit_L_20_xi * (((n/Nu_L_20)*(1/3000))^(-fit_L_20_xi)-1)
# Q_10000_L_20<- u_opt_L_20 + fit_L_20_sigma/fit_L_20_xi * (((n/Nu_L_20)*(1/30000))^(-fit_L_20_xi)-1)

# ## Parameter estimates - 305 candidates
# u_opt_L_305<-u_opt_L
# Nu_L_305<-length(x[x>u_opt_L_305])
# fit_L_305<- evir::gpd(x,u_opt_L_305)
# fit_L_305_xi<-fit_L_305$par.ests[[1]]
# fit_L_305_sigma<-fit_L_305$par.ests[[2]]
# 
# # 100, 1000, 1000 year return levels (3 observations per year)
# Q_100_L_305<- u_opt_L_305 + fit_L_305_sigma/fit_L_305_xi * (((n/Nu_L_305)*(1/300))^(-fit_L_305_xi)-1)
# Q_1000_L_305<- u_opt_L_305 + fit_L_305_sigma/fit_L_305_xi * (((n/Nu_L_305)*(1/3000))^(-fit_L_305_xi)-1)
# Q_10000_L_305<- u_opt_L_305 + fit_L_305_sigma/fit_L_305_xi * (((n/Nu_L_305)*(1/30000))^(-fit_L_305_xi)-1)
...
eva::gpdAd(x[x>3.304]-3.304)

# GOF ADtest Max cor QQplot choice
eva::gpdAd(x[x>4.136]-4.136)

#GOF aSTSM choice I=295
eva::gpdAd(x[x>7.752]-7.752)

# GOF ADtest ALRSM choice I=305
eva::gpdAd(x[x>4.17]-4.17)
...
plot(sort(x),exp_quantiles, ylab = bquote(log[] (1-p[i])), xlab=expression(x[i:n]), 
...
abline(v=quantile(gom,probs = c(.25,.50,.65,.80,.90,.95,.975,.99)), col='lightgray',lty=3)
grid(NA,NULL)      
